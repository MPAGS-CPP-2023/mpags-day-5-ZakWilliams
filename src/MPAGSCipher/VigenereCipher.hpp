...
#include "CaesarCipher.hpp" //VigenereCipher uses CaesarCipher on each letter
#include <string>
#include <map>
...
class VigenereCipher {
    ...
    private:
        ...
        // Lookup Table
        std::map<char,CaesarCipher> charLookup_; //Obtain CaesarCipher object from char object
